...
public class ImageInfo {
    ...
    public static final String PROJECTION_TYPE_EQUI = "Equirectangular";
    public static final String PROJECTION_TYPE_DUALFISH = "Dual-Fisheye";
    ...
    public void setProjectionType(String projectionType) { mProjectionType = projectionType; }
}
